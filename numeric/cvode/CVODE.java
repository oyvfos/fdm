 ...
 * 
 * based on CVODEOriginal.java by Reinhard Hemmerling
...
public class CVODE {
	...
	/*static{
		try{
			...
			System.out.println("cvode library not registered./n"+e);
		}
		try{
			Native.register("sundials_nvecserial");
		} catch(Error e) {
			System.out.println("nvecserial library not registered./n"+e);
		}
	}*/
